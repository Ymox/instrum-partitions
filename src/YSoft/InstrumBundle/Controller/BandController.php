...
use YSoft\InstrumBundle\Entity\Band;
...
class BandController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $bands = $em->getRepository('YSoftInstrumBundle:Band')->paginateBy(array(), array('name' => 'ASC'), $this->getParameter('paginate.per_page'), ($request->query->get('page', 1) - 1) * $this->getParameter('paginate.per_page'));
    ...
    {
        $band = new Band();
        $form = $this->createForm('YSoft\InstrumBundle\Form\BandType', $band, array(
    ...
    {
        $deleteForm = $this->createDeleteForm($band);
        $editForm = $this->createForm('YSoft\InstrumBundle\Form\BandType', $band);
